                    ...
                    <div className="steps mx-auto">
                        ...
                        <Row>
                            <Col md={6} xs={{ order: 1, span: 12 }} md={{ order: 12, span: 6 }} className="d-flex m-width m-0 g-0">
                                <img src="https://res.cloudinary.com/decorelm/image/upload/q_50/v1645996287/The_Direction_p3yi4m.webp" className="grow-img align-self-center ms-auto" />
                            </Col>
                        ...
                        <Row className="my-5">
                            ...
                            <Col md={6} className="d-flex m-0 g-0">
                                <img src="https://res.cloudinary.com/decorelm/image/upload/q_50/v1645996534/The_Designs_smffit.webp" className="grow-img align-self-center me-auto" />
                            </Col>
                        </Row>
                        <Row>
                            <Col md={6} xs={{ order: 1, span: 12 }} md={{ order: 12, span: 6 }} className="d-flex m-0 g-0">
                                <img src="https://res.cloudinary.com/decorelm/image/upload/q_50/v1645996775/Visualise_3D_nlvapv.webp" className="grow-img align-self-center ms-auto" />
                            </Col>
                        ...
                        <Row className="my-5">
                            ...
                            <Col md={6} className="d-flex m-0 g-0">
                                <img src="https://res.cloudinary.com/decorelm/image/upload/q_50/v1643830330/decorelm-website/Screenshot_2022-02-02_at_19.30.31_eykwka.webp" className="grow-img align-self-center me-auto" />
                            </Col>
                        </Row>
                        <Row>
                            <div className="mt-3 text-center">
                                <h4 className="header-tag mb-4">partners</h4>
                                <img src="https://www.westelm.co.uk/we-uk-18-2/extensions/PS/Theme_Westelm/18.2.4/img/West_Elm_logo.svg" style={{ maxWidth: '150px' }} className="mx-3 my-2" /><img src="https://www.coxandcox.co.uk/static/version1645181634/frontend/CoxAndCox/default/en_GB/images/logo.svg" style={{ maxWidth: '150px' }} className="mx-3 my-2" /><img src="https://media.made.com/mws-assets/images/MadeLogo.2.svg" style={{ maxWidth: '150px' }} className="mx-3 my-2" /><img src="https://res.cloudinary.com/decorelm/image/upload/q_50/v1645987614/Lick_tkxlt6.webp" style={{ maxWidth: '120px' }} className="mx-3 my-2" /><img src="https://res.cloudinary.com/decorelm/image/upload/q_50/v1645563331/decorelm-website/la-redoute-1_dh8t5t.webp" style={{ maxWidth: '150px' }} className="mx-3 my-2" />
