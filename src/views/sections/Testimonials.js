                    ...
                    <Row className="py-5 testimonial-box mx-auto">
                        <div className="align-self-center cta-padding">
                            ...
                            <div className="d-flex justify-content-center my-2">
                                <a href="https://www.bark.com/en/gb/company/decorelm-design-studio/RnVay/" target="_blank"><img className="me-3" src="https://res.cloudinary.com/decorelm/image/upload/v1646085413/services/Bark_g0oqrg.png" alt="Kerry Armstrong in Leeds, West Yorkshire, UK on Bark" style={{width: "75px"}}/></a>
