                    ...
                    <Row>
                        <Col md={6}>
                            <Row>
                                <Col md={6}>
                                    <Single
                                        img={"https://res.cloudinary.com/decorelm/image/upload/v1644521519/decorelm-website/7_er5owg.png"}
                                ...
                                <Col md={6}>
                                    <Single
                                        img={"https://res.cloudinary.com/decorelm/image/upload/v1644521219/decorelm-website/2_ozah6y.png"}
                            ...
                            <Row>
                                <Col>
                                    <Single
                                        img={"https://res.cloudinary.com/decorelm/image/upload/v1644521065/decorelm-website/1_pe7ssy.png"}
                                        titleTag={"eco edit"}
                        ...
                        <Col md={6}>
                            <Row>
                                <Col md={6}>
                                    <Single
                                        img="https://res.cloudinary.com/decorelm/image/upload/v1644521254/decorelm-website/3_gi4wf1.png"
                                        titleTag={"design tips"}
                                ...
                                <Col md={6}>
                                    <Single
                                        img={"https://res.cloudinary.com/decorelm/image/upload/v1644521272/decorelm-website/4_okxw9l.png"}
                                        titleTag={"design tips"}
                            ...
                            <Row>
                                <Col md={6}>
                                    <Single
                                        img={"https://res.cloudinary.com/decorelm/image/upload/v1644521291/decorelm-website/5_yehi01.png"}
                                        titleTag={"design tips"}
                                ...
                                <Col md={6}>
                                    <Single
                                        img={"https://res.cloudinary.com/decorelm/image/upload/v1644521322/decorelm-website/6_hw8lfb.png"}
                                        titleTag={"inspiration"}
                                        title={"Italy Inspo"}
